...
$opt_name = 'zboom';  // YOU MUST CHANGE THIS.  DO NOT USE 'zboom' IN YOUR PROJECT!!!
...
$args = array(
	...
	'page_title'                => esc_html__( 'Zboom theme', 'zboom' ),
...
$args['share_icons'][] = array(
	'url'   => '//github.com/asadbdp',
	'title' => 'Visit us on GitHub',
	'icon'  => 'el el-github',
);
$args['share_icons'][] = array(
	'url'   => '//www.facebook.com/asad.bdesh',
...
$args['share_icons'][] = array(
	'url'   => '//www.linkedin.com/company/triplei',
...
if ( ! isset( $args['global_variable'] ) || false !== $args['global_variable'] ) {
	...
	$args['intro_text'] = '<p>' . esc_html__( '', 'zboom' ) . '</p>';
}

// Add content after the form.
$args['footer_text'] = '<p>' . esc_html__( '', 'zboom' ) . '</p>';
 ...
 * ---> START SECTIONS
 */
require_once Redux_Core::$dir . '../sample/sections/general-section/general-sec.php';
  require_once Redux_Core::$dir . '../sample/sections/header/header-logo.php';
  require_once Redux_Core::$dir . '../sample/sections/footer/footer-text.php';
