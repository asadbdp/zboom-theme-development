...
Redux::set_section(
	...
	array(
		...
		'desc'       => esc_html__( 'These fields can be fully translated by WPML (WordPress Multi-Language). This serves as an example for you to implement.', 'your-textdomain-here' ),
		'subsection' => true,
		'fields'     => array(
			array(
				'id'    => 'wpml-text',
